...
class ReplayBuffer(object):
    ...
    def add_rollouts(self, paths, noised=False):
        ...
        # print("path size from add_rollouts 1", np.array(self.paths).shape)
        ...
        # print("observation size from add_rollouts 1", observations.shape)
    ...
    def sample_random_data(self, batch_size):
        ...
        # print("observation size from replay_buffer 1", self.obs.shape)
        # print("observation size from replay_buffer 1", self.acs.shape)


        # print("observation size from replay_buffer", self.obs[rand_indices].shape)
