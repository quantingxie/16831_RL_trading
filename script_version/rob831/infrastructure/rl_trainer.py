...
from rob831.envs import register_envs

register_envs()

df = pd.read_csv('rob831/envs/custom_trading/data/AAPL.csv')
...
class RL_Trainer(object):
    ...
    def __init__(self, params):
        ...
        # self.env = DummyVecEnv([lambda: StockTradingEnv(df)])
    ...
    def run_training_loop(self, n_iter, collect_policy, eval_policy,
        ...
        for itr in range(n_iter):
            ...
            if isinstance(self.agent, MBAgent):
                # Is only model based rl having noise?
...
#        print('Collecting train data...')
    ...
    def train_agent(self):
        ...
        for train_step in range(self.params['num_agent_train_steps_per_iter']):
            ...
            # print ("observation size from rl_trainner", obs_batch.shape)
