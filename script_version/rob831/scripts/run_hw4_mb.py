...
def main():
    ...
    parser.add_argument('--env_name', type=str, default='stocks-v0') #reacher-rob831-v0, ant-rob831-v0, cheetah-rob831-v0, obstacles-rob831-v0
    ...
    if params['env_name']=='reacher-rob831-v0':
        params['ep_len']=200
    if params['env_name']=='cheetah-rob831-v0':
        params['ep_len']=500
    if params['env_name']=='obstacles-rob831-v0':
        params['ep_len']=100
